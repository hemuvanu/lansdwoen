...
app.post('/mailer1',function(req , res){
    const sendmail = require('sendmail')({
        devPort: 4001, // Default: False
    ...
    sendmail({
    from: 'hemant@yopmail.com',
    to: 'hemantkashyap1995@gmail.com',
...
app.post('/mailer',function(req , res){
    ...
    let mailOptions = {
        from: "User Query 👻", // sender address
        to: 'hemant1@yopmail.com', // list of receivers
 ...
 */
publicDir = process.argv[2] || __dirname + '/public/dist/lansdowne',
